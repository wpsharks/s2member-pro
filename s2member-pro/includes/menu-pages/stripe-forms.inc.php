...
if(!class_exists('c_ws_plugin__s2member_pro_menu_page_stripe_forms'))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_stripe_forms
	{
		public function __construct()
		{
			...
			echo '<ul class="ws-menu-page-li-margins">'."\n";
			echo '<li><code>accept="bitcoin"</code> Accept Bitcoin? Defaults to the value that you configure globally. Please see: <strong>s2Member ⥱ Stripe Options ⥱ Account Details ⥱ Accept Bitcoin</strong>. If you want to exclude Bitcoin as an accepted form of payment on a particular Pro-Form, you can exclude Bitcoin by setting <code>accept=""</code> (i.e., to an empty string).</em></li>'."\n";
