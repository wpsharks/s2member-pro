...
if(!class_exists('c_ws_plugin__s2member_pro_gateways'))
{
	...
	class c_ws_plugin__s2member_pro_gateways
	{
		...
		{
			$gateways = array('alipay' => '<span style="opacity:0.5;"><strong>AliPay</strong> <em>(w/ Buttons)</em><br /><span style="font-size:90%;">&uarr; <a href="http://s2member.com/r/alipay-deprecation-kb-article/" target="_blank">Deprecated June 15th, 2015.</a></span></span>', 'stripe' => '<strong>Stripe + Bitcoin</strong> <em>(w/ Pro-Forms)</em><br /><span style="font-size:90%;">&uarr; supports Buy Now &amp; Recurring Products.</span>', 'authnet' => '<strong>Authorize.Net</strong> <em>(w/ Pro-Forms)</em><br /><span style="font-size:90%;">&uarr; supports Buy Now &amp; Recurring Products.</span>', 'ccbill' => '<span style="opacity:0.5;"><strong>ccBill</strong> <em>(w/ Buttons)</em><br /><span style="font-size:90%;">&uarr; <a href="http://s2member.com/r/ccbill-deprecation-kb-article/" target="_blank">Deprecated</a> June 15th, 2015.</span></span>', 'clickbank' => '<strong>ClickBank</strong> <em>(w/ Buttons)</em><br /><span style="font-size:90%;">&uarr; supports Buy Now &amp; Recurring Products.</span>', 'google' => '<span style="opacity:0.5;"><strong>Google Wallet</strong> <em>(w/ Buttons)</em><br /><span style="font-size:90%;">&uarr; <a href="http://www.s2member.com/r/google-wallet-retirement/" target="_blank" rel="external">retired by Google</a> March 2nd, 2015.</span></span>', 'paypal' => '<strong>PayPal Website Payments Pro</strong> <em>(w/ Pro-Forms)</em><br /><span style="font-size:90%;">&uarr; supports Buy Now &amp; Recurring Products.</span>');
