...
if(!class_exists("c_ws_plugin__s2member_pro_menu_page_coupon_codes"))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_coupon_codes
	{
		public function __construct()
		{
			...
			{
				echo '<div class="info">'."\n";
				echo '<p><strong>* Stripe Coupons (PLEASE NOTE):</strong> coupons MUST be configured with s2Member and <strong>NOT via the Stripe Dashboard please</strong>. s2Member Pro Forms currently do NOT support Stripe-generated coupon codes; only those configured with s2Member. Please see configuration options below.</p>'."\n";
				echo '</div>'."\n";
			}
