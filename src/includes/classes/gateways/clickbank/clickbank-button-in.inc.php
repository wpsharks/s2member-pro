				...
				public static function sc_clickbank_button($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						...
						if /* Modifications/Cancellations. */($attr["modify"] || $attr["cancel"])
							{
								$default_image = $GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"]."/src/images/clickbank-edit-button.png";
							...
							{
								$default_image = $GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"]."/src/images/clickbank-button.png";
