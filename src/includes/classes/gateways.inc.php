	...
	class c_ws_plugin__s2member_pro_gateways
	{
		...
		public static function available_gateways() // Payment Gateways available.
		{
			$gateways = array(
				...
				'alipay' => '<span style="opacity:0.5;"><strong>AliPay</strong> <em>(w/ Buttons)</em><br /><span style="font-size:80%;">&uarr; <a href="http://s2member.com/r/alipay-deprecation-kb-article/" target="_blank" rel="external">deprecated</a> June 15th, 2015.</span></span>',
				'ccbill' => '<span style="opacity:0.5;"><strong>ccBill</strong> <em>(w/ Buttons)</em><br /><span style="font-size:80%;">&uarr; <a href="http://s2member.com/r/ccbill-deprecation-kb-article/" target="_blank" rel="external">deprecated</a> June 15th, 2015.</span></span>',
			);
