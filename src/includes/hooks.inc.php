...
require_once dirname(__FILE__) . '/menu-pages/scripting-api-remote-ops.inc.php';
add_filter('s2x_during_general_options_page_remote_operations', 'c_ws_plugin__s2member_pro_menu_page_remote_ops_api::render');
