		...
		extends WP_Widget // See: /wp-includes/widgets.php for further details.
	{
		...
		public function form($instance = array())
		{
			...
			*/
			...
			echo '<small>(<a href="#" onclick="alert(\'Replacement Codes:\\n\\n%%current_user_login%% = The current User\\\'s Username, lowercase (deprecated).\\n%%current_user_nicename%% = The current User\\\'s Nicename, lowercase (recommended).\\n%%current_user_id%% = The current User\\\'s ID.\\n%%current_user_level%% = The current User\\\'s s2Member Level.\\n%%current_user_role%% = The current User\\\'s WordPress Role.'.((!is_multisite() || !c_ws_plugin__s2member_utils_conds::is_multisite_farm() || is_main_site()) ? '\\n%%current_user_ccaps%% = The current User\\\'s Custom Capabilities.' : '').'\\n%%current_user_logins%% = Number of times the current User has logged in.\\n\\nFor example, if you\\\'re using BuddyPress and you want to link Members to their BuddyPress account settings page, you would setup a URL like this one: '.site_url("/members/%%current_user_nicename%%/settings/").'\'); return false;">Replacement Codes</a> are available for use in custom URLs)</small><br />'."\n";
			echo '<small>(leave blank to exclude this link)</small><br /><br />'."\n";
			...
			echo '<small>(<a href="#" onclick="alert(\'Replacement Codes:\\n\\n%%current_user_login%% = The current User\\\'s Username, lowercase (deprecated).\\n%%current_user_nicename%% = The current User\\\'s Nicename, lowercase (recommended).\\n%%current_user_id%% = The current User\\\'s ID.\\n%%current_user_level%% = The current User\\\'s s2Member Level.\\n%%current_user_role%% = The current User\\\'s WordPress Role.'.((!is_multisite() || !c_ws_plugin__s2member_utils_conds::is_multisite_farm() || is_main_site()) ? '\\n%%current_user_ccaps%% = The current User\\\'s Custom Capabilities.' : '').'\\n%%current_user_logins%% = Number of times the current User has logged in.\\n\\nFor example, if you\\\'re using BuddyPress and you want to link Members to their BuddyPress profile page, you would setup a URL like this one: '.site_url("/members/%%current_user_nicename%%/profile/").'\'); return false;">Replacement Codes</a> are available for use in custom URLs)</small><br />'."\n";
			echo '<small>(leave blank to exclude this link)</small><br /><br />'."\n";
