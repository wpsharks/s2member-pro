...
if(!class_exists("c_ws_plugin__s2member_pro_menu_page_import_export"))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_import_export
	{
		public function __construct()
		{
			...
			$enable_advanced_tools = !empty($_REQUEST['enable_advanced_tools']);
			...
			else echo '<p style="text-align:right;"><a href="'.esc_attr(remove_query_arg('enable_advanced_tools')).'">click here to HIDE the Advanced Import/Export Tools</a> <i class="fa fa-eye-slash"></i></p>';
