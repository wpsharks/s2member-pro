...
<form id="s2member-pro-stripe-checkout-form" class="s2member-pro-stripe-form s2member-pro-stripe-checkout-form" method="post" action="%%action%%">
	...
	<div id="s2member-pro-stripe-checkout-form-billing-method-section" class="s2member-pro-stripe-form-section s2member-pro-stripe-checkout-form-section s2member-pro-stripe-form-billing-method-section s2member-pro-stripe-checkout-form-billing-method-section">
		...
		<div id="s2member-pro-stripe-checkout-form-card-type-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-card-type-div s2member-pro-stripe-checkout-form-card-type-div">
			%%card_type_options%%
		</div>
		<div id="s2member-pro-stripe-checkout-form-card-number-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-card-number-div s2member-pro-stripe-checkout-form-card-number-div">
			<label for="s2member-pro-stripe-checkout-card-number" id="s2member-pro-stripe-checkout-form-card-number-label" class="s2member-pro-stripe-form-card-number-label s2member-pro-stripe-checkout-form-card-number-label">
				<span><?php echo _x ("Card Number (no dashes or spaces)", "s2member-front", "s2member"); ?> *</span><br />
				<input type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_stripe_checkout[card_number]" id="s2member-pro-stripe-checkout-card-number" class="s2member-pro-stripe-card-number s2member-pro-stripe-checkout-card-number form-control" value="%%card_number_value%%" tabindex="210" />
			</label>
		</div>
		<div id="s2member-pro-stripe-checkout-form-card-expiration-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-card-expiration-div s2member-pro-stripe-checkout-form-card-expiration-div">
			<label for="s2member-pro-stripe-checkout-card-expiration" id="s2member-pro-stripe-checkout-form-card-expiration-label" class="s2member-pro-stripe-form-card-expiration-label s2member-pro-stripe-checkout-form-card-expiration-label">
				<span><?php echo _x ("Card Expiration Date (mm/yyyy)", "s2member-front", "s2member"); ?> *</span><br />
				<select aria-required="true" autocomplete="off" name="s2member_pro_stripe_checkout[card_expiration_month]" id="s2member-pro-stripe-checkout-card-expiration-month" class="s2member-pro-stripe-card-expiration-month s2member-pro-stripe-checkout-card-expiration-month form-control" tabindex="220">
					%%card_expiration_month_options%%
				</select>
				<select aria-required="true" autocomplete="off" name="s2member_pro_stripe_checkout[card_expiration_year]" id="s2member-pro-stripe-checkout-card-expiration-year" class="s2member-pro-stripe-card-expiration-year s2member-pro-stripe-checkout-card-expiration-year form-control" tabindex="221">
					%%card_expiration_year_options%%
				</select>
			</label>
		</div>
		<div id="s2member-pro-stripe-checkout-form-card-verification-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-card-verification-div s2member-pro-stripe-checkout-form-card-verification-div">
			<label for="s2member-pro-stripe-checkout-card-verification" id="s2member-pro-stripe-checkout-form-card-verification-label" class="s2member-pro-stripe-form-card-verification-label s2member-pro-stripe-checkout-form-card-verification-label">
				...
				<input type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_stripe_checkout[card_verification]" id="s2member-pro-stripe-checkout-card-verification" class="s2member-pro-stripe-card-verification s2member-pro-stripe-checkout-card-verification form-control" value="%%card_verification_value%%" tabindex="230" />
			</label>
		</div>
		<!-- This is displayed only when Maestro/Solo cards are selected as the Payment Method. -->
		<div id="s2member-pro-stripe-checkout-form-card-start-date-issue-number-div" class="s2member-pro-stripe-form-div  s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-card-start-date-issue-number-div s2member-pro-stripe-checkout-form-card-start-date-issue-number-div">
			<label for="s2member-pro-stripe-checkout-card-start-date-issue-number" id="s2member-pro-stripe-checkout-form-card-start-date-issue-number-label" class="s2member-pro-stripe-form-card-start-date-issue-number-label s2member-pro-stripe-checkout-form-card-start-date-issue-number-label">
				<span><?php echo _x ("Card Start Date (mm/yyyy), or Issue Number", "s2member-front", "s2member"); ?> *</span><br />
				<input type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_stripe_checkout[card_start_date_issue_number]" id="s2member-pro-stripe-checkout-card-start-date-issue-number" class="s2member-pro-stripe-card-start-date-issue-number s2member-pro-stripe-checkout-card-start-date-issue-number form-control" value="%%card_start_date_issue_number_value%%" tabindex="240" />
			</label>
		</div>
		<div style="clear:both;"></div>
	</div>
	...
	<div id="s2member-pro-stripe-checkout-form-billing-address-section" class="s2member-pro-stripe-form-section  s2member-pro-stripe-checkout-form-section s2member-pro-stripe-form-billing-address-section s2member-pro-stripe-checkout-form-billing-address-section">
		...
		<div id="s2member-pro-stripe-checkout-form-street-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-street-div s2member-pro-stripe-checkout-form-street-div">
			<label for="s2member-pro-stripe-checkout-street" id="s2member-pro-stripe-checkout-form-street-label" class="s2member-pro-stripe-form-street-label s2member-pro-stripe-checkout-form-street-label">
				...
				<input type="text" aria-required="true" maxlength="60" autocomplete="off" name="s2member_pro_stripe_checkout[street]" id="s2member-pro-stripe-checkout-street" class="s2member-pro-stripe-street s2member-pro-stripe-checkout-street form-control" value="%%street_value%%" tabindex="300" />
			</label>
		</div>
		<div id="s2member-pro-stripe-checkout-form-city-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-city-div s2member-pro-stripe-checkout-form-city-div">
			<label for="s2member-pro-stripe-checkout-city" id="s2member-pro-stripe-checkout-form-city-label" class="s2member-pro-stripe-form-city-label s2member-pro-stripe-checkout-form-city-label">
				...
				<input type="text" aria-required="true" maxlength="40" autocomplete="off" name="s2member_pro_stripe_checkout[city]" id="s2member-pro-stripe-checkout-city" class="s2member-pro-stripe-city s2member-pro-stripe-checkout-city form-control" value="%%city_value%%" tabindex="310" />
			</label>
		</div>
		...
		<div id="s2member-pro-stripe-checkout-form-country-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-country-div s2member-pro-stripe-checkout-form-country-div">
			<label for="s2member-pro-stripe-checkout-country" id="s2member-pro-stripe-checkout-form-country-label" class="s2member-pro-stripe-form-country-label s2member-pro-stripe-checkout-form-country-label">
				...
				<select aria-required="true" name="s2member_pro_stripe_checkout[country]" id="s2member-pro-stripe-checkout-country" class="s2member-pro-stripe-country s2member-pro-stripe-checkout-country form-control" tabindex="330">
					%%country_options%%
				</select>
			</label>
		</div>
		<div id="s2member-pro-stripe-checkout-form-zip-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-checkout-form-div s2member-pro-stripe-form-zip-div s2member-pro-stripe-checkout-form-zip-div">
			<label for="s2member-pro-stripe-checkout-zip" id="s2member-pro-stripe-checkout-form-zip-label" class="s2member-pro-stripe-form-zip-label s2member-pro-stripe-checkout-form-zip-label">
				...
				<input type="text" aria-required="true" maxlength="20" autocomplete="off" name="s2member_pro_stripe_checkout[zip]" id="s2member-pro-stripe-checkout-zip" class="s2member-pro-stripe-zip s2member-pro-stripe-checkout-zip form-control" value="%%zip_value%%" tabindex="340" />
			</label>
		</div>
