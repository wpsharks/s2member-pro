...
if(!class_exists('c_ws_plugin__s2member_pro_menu_page_stripe_forms'))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_stripe_forms
	{
		public function __construct()
		{
			...
			echo '<p><em><strong>*Cancellation Process*</strong> Very simple. A Member clicks a link to a Post/Page that contains a Cancellation Form you\'ve generated. The Member clicks the Submit button to confirm the cancellation. s2Member is notified silently behind-the-scenes, and will immediately cancel all future billing. s2Member will later terminate their account access, at the correct point in time. This works in conjunction with the s2Member Auto-EOT System. For further details, see: <code>s2Member ⥱ Stripe Options ⥱ EOT Behavior</code>.</em></p>'."\n";
			...
			echo '<ul class="ws-menu-page-li-margins">'."\n";
			echo '<li><code>accept="bitcoin"</code> Accept Bitcoin? Defaults to the value that you configure globally. Please see: <code>s2Member ⥱ Stripe Options ⥱ Account Details ⥱ Accept Bitcoin</code>. If you want to exclude Bitcoin as an accepted form of payment on a particular Pro-Form, you can exclude Bitcoin by setting <code>accept=""</code> (i.e., to an empty string).</em></li>'."\n";
