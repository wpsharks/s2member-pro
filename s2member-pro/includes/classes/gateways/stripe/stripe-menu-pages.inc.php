		...
		class c_ws_plugin__s2member_pro_stripe_menu_pages
			{
				...
				*/
				public static function stripe_admin_options ($add_divider = TRUE, $vars = FALSE)
					{
						...
						add_submenu_page ($vars["menu"], "s2Member Pro / Stripe Options", "Auth.Net Options", "create_users", "ws-plugin--s2member-pro-stripe-ops", "c_ws_plugin__s2member_pro_stripe_menu_pages::stripe_ops_page");
						add_submenu_page ($vars["menu"], "s2Member Pro / Stripe Pro Forms", "Auth.Net Pro-Forms", "create_users", "ws-plugin--s2member-pro-stripe-forms", "c_ws_plugin__s2member_pro_stripe_menu_pages::stripe_forms_page");
				...
				* @return null
				*/
				public static function stripe_scripting_page_api_constants ($vars = FALSE)
					{
				...
				public static function stripe_forms_page ()
					{
						if (c_ws_plugin__s2member_pro_stripe_responses::stripe_form_api_validation_errors ()) // Report error if Stripe Options are not yet configured.
							c_ws_plugin__s2member_admin_notices::display_admin_notice ('Please configure <code>s2Member -› Stripe Options</code> first. Once all of your Stripe Options are configured, return to this page &amp; generate your Authorize.net Form(s).', true);
