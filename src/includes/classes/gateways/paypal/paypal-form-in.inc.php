				...
				public static function sc_paypal_form($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						...
						if /* Cancellations. */($attr["cancel"])
						...
						else if /* Free registrations. */($attr["register"])
							{
								...
								*/
								$code = preg_replace("/%%first_name_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(esc_attr((string)(@$_p["s2member_pro_paypal_registration"]["first_name"]))), $code);
						...
						else if /* Billing information updates. */($attr["update"])
							{
								...
								*/
								...
								$code = preg_replace("/%%card_number_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["card_number"]))), $code);
								$code = preg_replace("/%%card_expiration_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["card_expiration"]))), $code);
								...
								$code = preg_replace("/%%card_verification_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["card_verification"]))), $code);
								$code = preg_replace("/%%card_start_date_issue_number_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["card_start_date_issue_number"]))), $code);
								/*
								Fill in the billing address section.
								*/
								$code = preg_replace("/%%street_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["street"]))), $code);
								$code = preg_replace("/%%city_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["city"]))), $code);
								$code = preg_replace("/%%state_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["state"]))), $code);
								$code = preg_replace("/%%country_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($country_options), $code);
								$code = preg_replace("/%%zip_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_update"]["zip"]))), $code);
								/*
								Fill the captcha section.
								*/
								$code = preg_replace("/%%captcha%%/", c_ws_plugin__s2member_utils_strings::esc_refs((string)@$captcha), $code);
						...
						else if /* Specific Post/Page Access. */($attr["sp"])
							{
								...
								*/
								...
								Fill in the registration section.
								*/
								$code = preg_replace("/%%first_name_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(esc_attr((string)(@$_p["s2member_pro_paypal_sp_checkout"]["first_name"]))), $code);
								$code = preg_replace("/%%last_name_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(esc_attr((string)(@$_p["s2member_pro_paypal_sp_checkout"]["last_name"]))), $code);
								$code = preg_replace("/%%email_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["email"]))), $code);
								/*
								Fill in the billing method section.
								*/
								$code = preg_replace("/%%card_type_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($card_type_options), $code);
								$code = preg_replace("/%%card_number_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["card_number"]))), $code);
								$code = preg_replace("/%%card_expiration_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["card_expiration"]))), $code);
								$code = preg_replace("/%%card_expiration_month_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($card_expiration_month_options), $code);
								$code = preg_replace("/%%card_expiration_year_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($card_expiration_year_options), $code);
								$code = preg_replace("/%%card_verification_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["card_verification"]))), $code);
								$code = preg_replace("/%%card_start_date_issue_number_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["card_start_date_issue_number"]))), $code);
								/*
								Fill in the billing address section.
								*/
								$code = preg_replace("/%%street_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["street"]))), $code);
								$code = preg_replace("/%%city_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["city"]))), $code);
								$code = preg_replace("/%%state_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["state"]))), $code);
								$code = preg_replace("/%%country_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($country_options), $code);
								$code = preg_replace("/%%zip_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_sp_checkout"]["zip"]))), $code);
								/*
								Fill the captcha section.
								*/
								$code = preg_replace("/%%captcha%%/", c_ws_plugin__s2member_utils_strings::esc_refs((string)@$captcha), $code);
						...
						else // Signups and Modifications.
							{
								...
								*/
								...
								Fill in the registration section.
								*/
								$code = preg_replace("/%%first_name_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(esc_attr((string)(@$_p["s2member_pro_paypal_checkout"]["first_name"]))), $code);
								...
								*/
								$code = preg_replace("/%%card_type_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($card_type_options), $code);
								$code = preg_replace("/%%card_number_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["card_number"]))), $code);
								$code = preg_replace("/%%card_expiration_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["card_expiration"]))), $code);
								$code = preg_replace("/%%card_expiration_month_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($card_expiration_month_options), $code);
								$code = preg_replace("/%%card_expiration_year_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($card_expiration_year_options), $code);
								$code = preg_replace("/%%card_verification_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["card_verification"]))), $code);
								$code = preg_replace("/%%card_start_date_issue_number_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["card_start_date_issue_number"]))), $code);
								/*
								Fill in the billing address section.
								*/
								$code = preg_replace("/%%street_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["street"]))), $code);
								$code = preg_replace("/%%city_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["city"]))), $code);
								$code = preg_replace("/%%state_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["state"]))), $code);
								$code = preg_replace("/%%country_options%%/", c_ws_plugin__s2member_utils_strings::esc_refs($country_options), $code);
								$code = preg_replace("/%%zip_value%%/", c_ws_plugin__s2member_utils_strings::esc_refs(format_to_edit((string)(@$_p["s2member_pro_paypal_checkout"]["zip"]))), $code);
								/*
								Fill the captcha section.
								*/
								$code = preg_replace("/%%captcha%%/", c_ws_plugin__s2member_utils_strings::esc_refs((string)@$captcha), $code);
