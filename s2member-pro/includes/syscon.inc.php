...
if(!function_exists('ws_plugin__s2member_pro_default_options'))
{
	...
	function ws_plugin__s2member_pro_default_options($default_options = array())
	{
		$pro_default_options = array( // Defaults for the Pro Add-on.
			...
			'pro_eot_reminder_email_subject'          => json_encode((object)array('_' => _x('Renewal Reminder (Account Expires Soon)', 's2member-front', 's2member'))),
			'pro_eot_reminder_email_message'          => json_encode((object)array('_' => sprintf(_x("If you have any trouble, please feel free to contact us.\n\nBest Regards,\n%s", 's2member-front', 's2member'), get_bloginfo('name')))),
