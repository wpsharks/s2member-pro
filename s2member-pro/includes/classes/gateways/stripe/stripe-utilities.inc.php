		...
		class c_ws_plugin__s2member_pro_stripe_utilities
			{
				...
				*/
				public static function stripe_aim_response($post_vars = FALSE)
					{
						...
						*/
						...
						$log2 = (is_multisite() && !is_main_site()) ? "stripe-api-4-".trim(preg_replace("/[^a-z0-9]/i", "-", $_log4), "-").".log" : "stripe-api.log";
				...
				*/
				public static function _stripe_aim_response_filters($response = FALSE)
					{
				...
				* @todo Continue optimizing this routine with ``empty()`` and ``isset()``.
				*/
				public static function stripe_arb_response($post_vars = FALSE)
					{
						global /* For Multisite support. */ $current_site, $current_blog;
				...
				*/
				public static function _stripe_parse_arb_response($xml = FALSE)
					{
				...
				* @return array An array of response variables; possibly modified by this routine.
				*/
				public static function _stripe_arb_response_filters($response = FALSE)
					{
						return $response; // Nothing here yet.
					}
				/**
				...
				*/
				public static function stripe_start_time($period1 = FALSE, $period3 = FALSE)
					{
				...
				*/
				public static function stripe_per_term_2_days($period = FALSE, $term = FALSE)
					{
				...
				*/
				public static function stripe_exp_date($exp = FALSE)
					{
				...
				* @todo Candidate for the use of ``ifsetor()``?
				*/
				public static function stripe_parse_arb_desc($array = FALSE)
					{
				...
				*/
				public static function stripe_cost($trial_sub_total = FALSE, $sub_total = FALSE, $state = FALSE, $country = FALSE, $zip = FALSE, $currency = FALSE, $desc = FALSE)
					{
				...
				*/
				public static function stripe_apply_coupon($attr = FALSE, $coupon_code = FALSE, $return = FALSE, $process = FALSE)
					{
