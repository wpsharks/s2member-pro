...
if(!class_exists("c_ws_plugin__s2member_pro_menu_page_authnet_forms"))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_authnet_forms
	{
		public function __construct()
		{
			...
			do_action("ws_plugin__s2member_during_authnet_forms_page_before_left_sections", get_defined_vars());
			...
			echo (!is_multisite() || !c_ws_plugin__s2member_utils_conds::is_multisite_farm() || is_main_site()) ? '<li><code>template=""</code> 100% optional. This can be a custom template file inside <code>WP_CONTENT_DIR</code>, including your WordPress theme directory. Custom filenames must be approved under <strong>s2Member → General Options → Pro Shortcode Templates Whitelist</strong>. Standard Authorize.Net Pro-Form template filenames are allowed automatically. For example: <code>template="checkout.php"</code>. Please see <a href="http://s2member.com/kb-article/can-i-customize-pro-forms/" target="_blank" rel="external">this KB article</a> for further details.</li>'."\n" : ''; //260812 Mention whitelist.
