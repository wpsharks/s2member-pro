				...
				public static function google_jwt ()
					{
						...
						//260808 Safely unserialize the Google payment attributes.
						$attr = (array)c_ws_plugin__s2member_utils_arrays::maybe_unserialize(c_ws_plugin__s2member_utils_encryption::decrypt($attr));
