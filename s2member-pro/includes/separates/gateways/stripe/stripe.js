...
jQuery(document).ready (function($)
	{
		...
		if($('form.s2member-pro-stripe-registration-form').length > 1 || $('form.s2member-pro-stripe-checkout-form').length > 1 || $('form.s2member-pro-stripe-sp-checkout-form').length > 1)
		...
		if (($clForm = $('form#s2member-pro-stripe-cancellation-form')).length === 1)
			{
				var captchaSection = 'div#s2member-pro-stripe-cancellation-form-captcha-section', submissionSection = 'div#s2member-pro-stripe-cancellation-form-submission-section', $submissionButton = $(submissionSection + ' button#s2member-pro-stripe-cancellation-submit');
			...
			{
				var handleBillingMethod, billingMethodSection = 'div#s2member-pro-stripe-update-form-billing-method-section', billingAddressSection = 'div#s2member-pro-stripe-update-form-billing-address-section', cardType = billingMethodSection + ' input[name="s2member_pro_stripe_update\[card_type\]"]', captchaSection = 'div#s2member-pro-stripe-update-form-captcha-section', submissionSection = 'div#s2member-pro-stripe-update-form-submission-section', $submissionButton = $(submissionSection + ' button#s2member-pro-stripe-update-submit');
			...
			{
				var handleNameIssues, handlePasswordIssues, registrationSection = 'div#s2member-pro-stripe-registration-form-registration-section', captchaSection = 'div#s2member-pro-stripe-registration-form-captcha-section', submissionSection = 'div#s2member-pro-stripe-registration-form-submission-section', $submissionButton = $(submissionSection + ' button#s2member-pro-stripe-registration-submit');
				...
				$rgForm.submit ( /* Form validation. */function()
					{
						...
						var $password1 = $(registrationSection + ' input#s2member-pro-stripe-registration-password1[aria-required="true"]');
						var $password2 = $(registrationSection + ' input#s2member-pro-stripe-registration-password2');
			...
			{
				var handleOptions, handleCouponIssues, handleTaxIssues, taxMayApply = true, calculateTax, cTaxDelay, cTaxTimeout, cTaxReq, cTaxLocation, handleExistingUsers, handleBillingMethod, optionsSection = 'div#s2member-pro-stripe-sp-checkout-form-options-section', descSection = 'div#s2member-pro-stripe-sp-checkout-form-description-section', couponSection = 'div#s2member-pro-stripe-sp-checkout-form-coupon-section', couponApplyButton = couponSection + ' input#s2member-pro-stripe-sp-checkout-coupon-apply', registrationSection = 'div#s2member-pro-stripe-sp-checkout-form-registration-section', billingMethodSection = 'div#s2member-pro-stripe-sp-checkout-form-billing-method-section', cardType = billingMethodSection + ' input[name="s2member_pro_stripe_sp_checkout\[card_type\]"]', billingAddressSection = 'div#s2member-pro-stripe-sp-checkout-form-billing-address-section', $ajaxTaxDiv = $(billingAddressSection + ' > div#s2member-pro-stripe-sp-checkout-form-ajax-tax-div'), captchaSection = 'div#s2member-pro-stripe-sp-checkout-form-captcha-section', submissionSection = 'div#s2member-pro-stripe-sp-checkout-form-submission-section', submissionNonceVerification = submissionSection + ' input#s2member-pro-stripe-sp-checkout-nonce', submissionButton = submissionSection + ' button#s2member-pro-stripe-sp-checkout-submit';
						...
						if (taxMayApply && !(eventTrigger && eventTrigger.interval && document.activeElement.id === 's2member-pro-stripe-sp-checkout-country'))
							{
								...
								var state = $.trim ($(billingAddressSection + ' input#s2member-pro-stripe-sp-checkout-state').val ());
								var country = $(billingAddressSection + ' select#s2member-pro-stripe-sp-checkout-country').val ();
								var zip = $.trim ($(billingAddressSection + ' input#s2member-pro-stripe-sp-checkout-zip').val ());
				...
				(handleExistingUsers = /* eventTrigger is passed by jQuery for DOM events. */ function(eventTrigger)
					{
						if /* If User/Member is already logged in. */ (S2MEMBER_CURRENT_USER_IS_LOGGED_IN)
							{
								$(registrationSection + ' input#s2member-pro-stripe-sp-checkout-first-name').each (function()
									{
										var $this = $(this), val = $this.val ();
										(!val) ? $this.val (S2MEMBER_CURRENT_USER_FIRST_NAME) : null;
									});

								$(registrationSection + ' input#s2member-pro-stripe-sp-checkout-last-name').each (function()
									{
										var $this = $(this), val = $this.val ();
										(!val) ? $this.val (S2MEMBER_CURRENT_USER_LAST_NAME) : null;
									});

								$(registrationSection + ' input#s2member-pro-stripe-sp-checkout-email').each (function()
									{
										var $this = $(this), val = $this.val ();
			...
			{
				var handleOptions, handleCouponIssues, handleTaxIssues, taxMayApply = true, calculateTax, cTaxDelay, cTaxTimeout, cTaxReq, cTaxLocation, handlePasswordIssues, handleBillingMethod, handleExistingUsers, optionsSection = 'div#s2member-pro-stripe-checkout-form-options-section', descSection = 'div#s2member-pro-stripe-checkout-form-description-section', couponSection = 'div#s2member-pro-stripe-checkout-form-coupon-section', couponApplyButton = couponSection + ' input#s2member-pro-stripe-checkout-coupon-apply', registrationSection = 'div#s2member-pro-stripe-checkout-form-registration-section', customFieldsSection = 'div#s2member-pro-stripe-checkout-form-custom-fields-section', billingMethodSection = 'div#s2member-pro-stripe-checkout-form-billing-method-section', cardType = billingMethodSection + ' input[name="s2member_pro_stripe_checkout\[card_type\]"]', billingAddressSection = 'div#s2member-pro-stripe-checkout-form-billing-address-section', $ajaxTaxDiv = $(billingAddressSection + ' > div#s2member-pro-stripe-checkout-form-ajax-tax-div'), captchaSection = 'div#s2member-pro-stripe-checkout-form-captcha-section', submissionSection = 'div#s2member-pro-stripe-checkout-form-submission-section', submissionNonceVerification = submissionSection + ' input#s2member-pro-stripe-checkout-nonce', submissionButton = submissionSection + ' button#s2member-pro-stripe-checkout-submit';
				...
				(handleExistingUsers = /* eventTrigger is passed by jQuery for DOM events. */ function(eventTrigger)
					{
						if /* If User/Member is already logged in. */ (S2MEMBER_CURRENT_USER_IS_LOGGED_IN)
							{
								$(registrationSection + ' input#s2member-pro-stripe-checkout-first-name').each (function()
									{
										var $this = $(this), val = $this.val ();
										(!val) ? $this.val (S2MEMBER_CURRENT_USER_FIRST_NAME) : null;
									});

								$(registrationSection + ' input#s2member-pro-stripe-checkout-last-name').each (function()
									{
										var $this = $(this), val = $this.val ();
										(!val) ? $this.val (S2MEMBER_CURRENT_USER_LAST_NAME) : null;
									});
				...
				$(registrationSection + ' > div#s2member-pro-stripe-checkout-form-password-div :input').keyup (function()
					{
						ws_plugin__s2member_passwordStrength($(registrationSection + ' input#s2member-pro-stripe-checkout-username'), $(registrationSection + ' input#s2member-pro-stripe-checkout-password1'), $(registrationSection + ' input#s2member-pro-stripe-checkout-password2'), $(registrationSection + ' div#s2member-pro-stripe-checkout-form-password-strength'));
					});
						...
						if ($.inArray($(submissionNonceVerification).val (), ['option', 'apply-coupon']) === -1)
							{
								...
								var $password1 = $(registrationSection + ' input#s2member-pro-stripe-checkout-password1[aria-required="true"]');
								var $password2 = $(registrationSection + ' input#s2member-pro-stripe-checkout-password2');
		...
		(jumpToResponses = /* Jump to form responses. Make sure Customers see messages. */ function()
			{
				$('div#s2member-pro-stripe-form-response').each (function()
					{
