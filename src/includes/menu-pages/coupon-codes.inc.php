...
if(!class_exists("c_ws_plugin__s2member_pro_menu_page_coupon_codes"))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_coupon_codes
	{
		public function __construct()
		{
			...
			do_action("ws_plugin__s2member_during_coupon_codes_page_before_left_sections_form", get_defined_vars());
			...
			//cho '<iframe width="560" height="315" src="https://www.youtube.com/embed/T3N_vygowbM" frameborder="0" allowscriptaccess="always" allowfullscreen="true" style="float:right; margin:0 0 20px 20px; width:300px; height:200px;"></iframe>'."\n";
			...
			// echo 'For a full tutorial on using the Gift/Redemption Codes, please see the <a href="http://s2member.com/r/giftredemption-codes-video/" target="_blank">Video Tutorial</a> embedded to the right.</p>'."\n";
