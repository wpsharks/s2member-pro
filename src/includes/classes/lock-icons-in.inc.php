				...
				public static function _return_lock_icons_description ($array = FALSE)
					{
						...
						$desc = (!empty($req)) ? '<img src="' . esc_attr ($dir_url) . '/src/images/lock-icon.png" style="cursor:help; width:16px; border:0;" title="' . esc_attr ($req) . '" />' : '<span style="cursor:help;" title="Publicly Available">&mdash;</span>';
