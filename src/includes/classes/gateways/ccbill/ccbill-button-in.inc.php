				...
				public static function sc_ccbill_button($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						...
						if /* ccBill Modifications/Cancellations. */($attr["modify"] || $attr["cancel"])
							{
								$default_image = $GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"]."/src/images/ccbill-edit-button.png";
							...
							{
								$default_image = $GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"]."/src/images/ccbill-button.png";
