 ...
 * @since 260914.0409 Heavy reminder processing moved here when `reminders.inc.php` became the lightweight outer gate.
 */
if (!defined('WPINC')) { // MUST have.
    exit('Do not access this file directly.');
}
if (!class_exists('c_ws_plugin__s2member_pro_reminders_in')) {
    /**
     * Reminders (inner processing routines).
     *
     * @since 151202 Reminders.
     * @since 260914.0409 Split from the lightweight outer reminder gate.
     */
    class c_ws_plugin__s2member_pro_reminders_in
    {
