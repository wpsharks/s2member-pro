...
if(!class_exists("c_ws_plugin__s2member_pro_menu_page_gen_ops_captcha_ops"))
{
	...
	{
		/**
		 * @attaches-to ``add_action('s2x_during_payment_gateways_options_page_captcha');``
		 */
