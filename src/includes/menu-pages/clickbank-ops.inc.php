...
if(!class_exists("c_ws_plugin__s2member_pro_menu_page_clickbank_ops"))
{
	...
	class c_ws_plugin__s2member_pro_menu_page_clickbank_ops
	{
		public function __construct()
		{
			...
			echo '<p>The ClickBank IPN service will notify s2Member whenever a refund or chargeback occurs. For example, if you issue a refund to an unhappy Customer through ClickBank, s2Member will eventually be notified, and the account for that Customer will either be demoted to a Free Subscriber, or have the configured Delete behavior applied automatically. ~ Otherwise, under normal circumstances, s2Member will not process an EOT until the User has completely used up the time they paid for.</em></p>'."\n";
