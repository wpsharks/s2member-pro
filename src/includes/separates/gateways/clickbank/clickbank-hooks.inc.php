...
add_action('s2x_during_payment_gateways_options_page_gateways_settings', 'c_ws_plugin__s2member_pro_menu_page_clickbank_ops::render_clickbank_settings_panels');
