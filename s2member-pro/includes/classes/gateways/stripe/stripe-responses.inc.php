		...
		class c_ws_plugin__s2member_pro_stripe_responses
			{
				...
				*/
				public static function stripe_cancellation_response($attr = FALSE)
					{
				...
				* @return array An array of response details.
				*/
				public static function stripe_update_response($attr = FALSE)
					{
				...
				* @return array An array of response details.
				*/
				public static function stripe_registration_response($attr = FALSE)
					{
				...
				* @return array An array of response details.
				*/
				public static function stripe_sp_checkout_response($attr = FALSE)
					{
				...
				* @return array An array of response details.
				*/
				public static function stripe_checkout_response($attr = FALSE)
					{
				...
				*/
				public static function stripe_form_api_validation_errors($attr = FALSE)
					{
				...
				* @return null|array Null if there are no errors, else a response array.
				*/
				public static function stripe_form_attr_validation_errors($attr = FALSE)
					{
				...
				* @return null|array Null if there are no errors, else a response array.
				*/
				public static function stripe_form_submission_validation_errors($form = FALSE, $s = FALSE)
					{
