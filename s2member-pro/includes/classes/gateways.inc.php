...
if(!class_exists('c_ws_plugin__s2member_pro_gateways'))
{
	...
	class c_ws_plugin__s2member_pro_gateways
	{
		...
		{
			$gateways = array('alipay' => '<strong>AliPay</strong> <em>(w/ Buttons)</em><br />&uarr; <a href="https://s2member.com/?p=2904" target="_blank">Deprecated</a> June 15th, 2015.', 'stripe' => '<strong>Stripe + Bitcoin</strong> <em>(w/ Pro-Forms)</em><br />&uarr; supports Buy Now &amp; Recurring Products.', 'authnet' => '<strong>Authorize.Net</strong> <em>(w/ Pro-Forms)</em><br />&uarr; supports Buy Now &amp; Recurring Products.', 'ccbill' => '<strong>ccBill</strong> <em>(w/ Buttons)</em><br />&uarr; <a href="http://s2member.com/?p=2878" target="_blank">Deprecated</a> June 15th, 2015.', 'clickbank' => '<strong>ClickBank</strong> <em>(w/ Buttons)</em><br />&uarr; supports Buy Now &amp; Recurring Products.', 'google' => '<strong>Google Wallet</strong> <em>(w/ Buttons)</em><br />&uarr; <a href="http://www.s2member.com/r/google-wallet-retirement/" target="_blank" rel="external">retired by Google</a> March 2nd, 2015.', 'paypal' => '<strong>PayPal Website Payments Pro</strong> <em>(w/ Pro-Forms)</em><br />&uarr; supports Buy Now &amp; Recurring Products.');
