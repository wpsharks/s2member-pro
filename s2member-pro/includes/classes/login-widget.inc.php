		...
		extends WP_Widget // See: /wp-includes/widgets.php for further details.
	{
		...
		public function form($instance = array())
		{
			...
			*/
			...
			echo '<label for="'.esc_attr($this->get_field_id('code')).'">Additional XHTML'.((!is_multisite() || !c_ws_plugin__s2member_utils_conds::is_multisite_farm() || is_main_site()) ? '/PHP' : '').' Code or Shortcode?</label><br />'."\n";
