				...
				public static function wizard()
					{
						...
						if(is_array($credentials = request_filesystem_credentials($_SERVER["REQUEST_URI"], false, (($error) ? new WP_Error("s2member_pro_upgrade_error", $error) : false), dirname(dirname(dirname(dirname(dirname(__FILE__))))), array("ws_plugin__s2member_pro_upgrade", "ws_plugin__s2member_pro_upgrade_username", "ws_plugin__s2member_pro_upgrade_password"))))
