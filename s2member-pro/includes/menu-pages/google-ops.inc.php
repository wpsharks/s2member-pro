				...
				public function __construct ()
					{
						...
						echo '<p><em><strong>Note:</strong> if you\'re following the Google Wallet <strong>Implementation Tips</strong> above (e.g. a customer registers first, before checkout); this email is rarely used. Customers that pay through Google Wallet will be upgrading their existing free account with you; and in that case you\'ll want to customize the Modification Confirmation Email below for those customers. This Signup Confirmation Email is only for <strong>new</strong> customers that do NOT have an account on your site yet (free, or otherwise).</em></p>' . "\n";
						...
						echo '<li><code>%%subscr_id%%</code> = A unique Subscription ID (e.g. the Google Wallet Order ID).</li>' . "\n";
						...
						echo '<strong>You can also use these special Replacement Codes if you need them:</strong>'."\n";
						echo '<ul>'."\n";
						echo '<li><code>%%txn_id%%</code> = A unique Transaction ID for this purchase (e.g. a Google Wallet Order ID).</li>' . "\n";
