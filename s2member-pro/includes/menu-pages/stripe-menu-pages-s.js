...
jQuery(document).ready (function($)
	{
		...
		if (location.href.match (/page\=ws-plugin--s2member-pro-stripe-ops/))
			...
			{
				var taxMayApply = ('<?php echo (int)c_ws_plugin__s2member_pro_stripe_utilities::stripe_tax_may_apply(); ?>' === '1') ? true : false;
				...
				ws_plugin__s2member_pro_stripeFormGenerate = /* Handles Stripe Form Generation. */ function(form)
					{
						...
						if (trialAmount !== '0' && (isNaN(trialAmount) || trialAmount < 0.00))
							...
							{
								alert('— Oops, a slight problem: —\n\nMax paid Trial Period Years is: 1. *This is an Stripe limitation.');
								return false;
							}
				...
				ws_plugin__s2member_pro_stripeCcapFormGenerate = /* Handles Stripe Form Generation. */ function(form)
					{
