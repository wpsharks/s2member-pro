...
add_action('ws_plugin__s2member_during_paypal_ops_page_during_left_sections_after_eot_behavior', 'c_ws_plugin__s2member_pro_paypal_menu_pages::paypal_ops_reminder_email');
add_action('s2x_during_email_options_page_during_left_sections_after_signup_confirmation_email', 'c_ws_plugin__s2member_pro_paypal_menu_pages::paypal_ops_page_signup_email');
add_action('s2x_during_email_options_page_during_left_sections_after_sp_confirmation_email', 'c_ws_plugin__s2member_pro_paypal_menu_pages::paypal_ops_page_sp_email');
add_action('s2x_during_email_options_page_after_left_sections', 'c_ws_plugin__s2member_pro_paypal_menu_pages::paypal_ops_reminder_email');
add_action('ws_plugin__s2member_during_paypal_ops_page_after_left_sections', 'c_ws_plugin__s2member_pro_paypal_menu_pages::paypal_ops_page_tax_rates');
require_once dirname(__FILE__, 4) . '/menu-pages/paypal-ops-payflow.inc.php';
add_action('ws_plugin__s2member_during_paypal_ops_page_during_left_sections_after_paypal_account_details', 'c_ws_plugin__s2member_pro_menu_page_paypal_ops_payflow::render');
add_action('s2x_during_payment_gateways_options_page_during_left_sections_after_paypal_account_details', 'c_ws_plugin__s2member_pro_menu_page_paypal_ops_payflow::render');
