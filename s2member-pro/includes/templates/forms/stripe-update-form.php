...
<form id="s2member-pro-stripe-update-form" class="s2member-pro-stripe-form s2member-pro-stripe-update-form" method="post" action="%%action%%">
	...
	<div id="s2member-pro-stripe-update-form-billing-method-section" class="s2member-pro-stripe-form-section s2member-pro-stripe-update-form-section s2member-pro-stripe-form-billing-method-section s2member-pro-stripe-update-form-billing-method-section">
		...
		<div id="s2member-pro-stripe-update-form-card-token-div" class="s2member-pro-stripe-form-div s2member-pro-stripe-update-form-div s2member-pro-stripe-form-card-token-div s2member-pro-stripe-update-form-card-token-div">
			<button id="s2member-pro-stripe-update-form-card-token-button" class="s2member-pro-stripe-form-card-token-button s2member-pro-stripe-update-form-card-token-button" type="button">
				<i><?php echo _x("[+]", "s2member-front", "s2member"); ?></i> <span><?php echo _x("New Billing Method", "s2member-front", "s2member"); ?></span>
			</button>
			<div id="s2member-pro-stripe-update-form-card-token-summary" class="s2member-pro-stripe-form-card-token-summary s2member-pro-stripe-update-form-card-token-summary">
				%%card_token_summary%%
			</div>
		</div>
		<div style="clear:both;"></div>
